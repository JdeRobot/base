...
extern void eyeoperator1_startup(char *configfile);
...
extern void eyeoperator1_guisuspend();

extern int eyeoperator1_id; /* schema identifier */
extern int eyeoperator1_cycle; /* ms */
