...
public abstract class _BodyMovementsDisp extends Ice.ObjectImpl implements BodyMovements
{
    ...
    public final int doMovement(BodyMovementsData data)
    {
        return doMovement(data, null);
    }

    public final BodyMovementsData getMovement()
    {
        return getMovement(null);
    }

    public static Ice.DispatchStatus ___doMovement(BodyMovements __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
    ...
    public static Ice.DispatchStatus ___getMovement(BodyMovements __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
