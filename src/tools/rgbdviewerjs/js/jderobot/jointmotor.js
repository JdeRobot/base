...
(function(global, r)
{
    ...
    var Ice = global.Ice || {};
    var RoboCompJointMotor = global.RoboCompJointMotor ||  {};
    ...
    RoboCompJointMotor.MotorState = Slice.defineStruct(
        ...
        22, 
        false);
    Slice.defineDictionary(RoboCompJointMotor, "MotorStateMap", "MotorStateMapHelper", "Ice.StringHelper", "RoboCompJointMotor.MotorState", false, false);
    ...
    RoboCompJointMotor.BusParams = Slice.defineStruct(
        ...
        {
            this.handler = handler !== undefined ? handler : null;
            this.device = device !== undefined ? device : null;
    ...
    global.RoboCompJointMotor = RoboCompJointMotor;
}
