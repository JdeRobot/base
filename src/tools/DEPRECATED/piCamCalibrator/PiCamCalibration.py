'''
Este programa coge las 20 imagenes de tablero de ajedrez tomadas por la Picam previamente, y que se encuentran en la carpeta "chess_board".

En estas imagenes, el algoritmo encuentra las esquinas y finalmente devuelve la matriz de parametros intrinsecos de la PiCam.
'''
...
images = glob.glob('chess_board3/*.png')
