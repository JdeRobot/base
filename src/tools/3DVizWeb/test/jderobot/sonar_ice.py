...
if 'SonarData' not in _M_jderobot.__dict__:
    ...
    class SonarData(Ice.Object):
        ...
        def ice_ids(self, current=None):
            return ('::Ice::Object', '::jderobot::SonarData')
    ...
    _M_jderobot.SonarDataPrx = Ice.createTempClass()
    class SonarDataPrx(Ice.ObjectPrx):

        def checkedCast(proxy, facetOrCtx=None, _ctx=None):
            return _M_jderobot.SonarDataPrx.ice_checkedCast(proxy, '::jderobot::SonarData', facetOrCtx, _ctx)
    ...
    _M_jderobot._t_SonarDataPrx = IcePy.defineProxy('::jderobot::SonarData', SonarDataPrx)

    _M_jderobot._t_SonarData = IcePy.defineClass('::jderobot::SonarData', SonarData, -1, (), False, False, None, (), (
...
if 'Sonar' not in _M_jderobot.__dict__:
    ...
    class Sonar(Ice.Object):
        ...
        """
        def __init__(self):
            if Ice.getType(self) == _M_jderobot.Sonar:
                raise RuntimeError('jderobot.Sonar is an abstract class')
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_Sonar)
    ...
    class SonarPrx(Ice.ObjectPrx):
        ...
        def getSonarData(self, _ctx=None):
            return _M_jderobot.Sonar._op_getSonarData.invoke(self, ((), _ctx))

        def begin_getSonarData(self, _response=None, _ex=None, _sent=None, _ctx=None):
            return _M_jderobot.Sonar._op_getSonarData.begin(self, ((), _response, _ex, _sent, _ctx))

        def end_getSonarData(self, _r):
            return _M_jderobot.Sonar._op_getSonarData.end(self, _r)

        def checkedCast(proxy, facetOrCtx=None, _ctx=None):
            return _M_jderobot.SonarPrx.ice_checkedCast(proxy, '::jderobot::Sonar', facetOrCtx, _ctx)
        checkedCast = staticmethod(checkedCast)
    ...
    _M_jderobot._t_Sonar = IcePy.defineClass('::jderobot::Sonar', Sonar, -1, (), True, False, None, (), ())
    Sonar._ice_type = _M_jderobot._t_Sonar
