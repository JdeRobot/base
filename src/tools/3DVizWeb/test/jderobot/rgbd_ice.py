...
if 'rgbd' not in _M_jderobot.__dict__:
    _M_jderobot.rgbd = Ice.createTempClass()
    class rgbd(Ice.Object):
        def __init__(self):
            if Ice.getType(self) == _M_jderobot.rgbd:
                raise RuntimeError('jderobot.rgbd is an abstract class')
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_rgbd)
    ...
    class rgbdPrx(Ice.ObjectPrx):
        ...
        def getData(self, _ctx=None):
            return _M_jderobot.rgbd._op_getData.invoke(self, ((), _ctx))

        def begin_getData(self, _response=None, _ex=None, _sent=None, _ctx=None):
            return _M_jderobot.rgbd._op_getData.begin(self, ((), _response, _ex, _sent, _ctx))

        def end_getData(self, _r):
            return _M_jderobot.rgbd._op_getData.end(self, _r)

        def checkedCast(proxy, facetOrCtx=None, _ctx=None):
            return _M_jderobot.rgbdPrx.ice_checkedCast(proxy, '::jderobot::rgbd', facetOrCtx, _ctx)
        checkedCast = staticmethod(checkedCast)
    ...
    _M_jderobot._t_rgbd = IcePy.defineClass('::jderobot::rgbd', rgbd, -1, (), True, False, None, (), ())
    rgbd._ice_type = _M_jderobot._t_rgbd
