...
( function () {
	...
	THREE.TransformGizmoTranslate = function () {
		...
		this.handleGizmos = {
			...
			XZ: [
				[ new THREE.Mesh( new THREE.PlaneBufferGeometry( 0.5, 0.5 ), new GizmoMaterial( { color: 0xff00ff, opacity: 0.25 } ) ), [ 0, 0, 0 ], [ - Math.PI / 2, 0, 0 ] ]
		...
		this.pickerGizmos = {
			...
			XZ: [
				[ new THREE.Mesh( new THREE.PlaneBufferGeometry( 0.5, 0.5 ), pickerMaterial ), [ 0, 0, 0 ], [ - Math.PI / 2, 0, 0 ] ]
