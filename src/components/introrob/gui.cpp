...
namespace introrob {
    ...
    bool Gui::on_button_press_canvas_teleoperate_cameras(GdkEvent * event) {
        ...
        api->v_normalized = v_normalized / 20;
        api->w_normalized = w_normalized*-3;
    ...
    void Gui::teleoperateCameras() {
        ...
        w_normalized = tilt * (-5.263157895) + 100;
        v_normalized = -pan * (1.754385965) + 100;

        w_canvas_teleoperate_cameras->get_window()->draw_line(gc_teleoperate_cameras, 0, w_normalized, 200, w_normalized);
        w_canvas_teleoperate_cameras->get_window()->draw_line(gc_teleoperate_cameras, v_normalized, 0, v_normalized, 200);
