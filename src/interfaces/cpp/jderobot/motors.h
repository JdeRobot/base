...
public:
    ...
    ::IceInternal::ProxyHandle<Motors> ice_context(const ::Ice::Context& __context) const
    {
        ...
        return dynamic_cast<Motors*>(_Base::ice_context(__context).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_adapterId(__id).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_endpoints(__endpoints).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_locatorCacheTimeout(__timeout).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_connectionCached(__cached).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_endpointSelection(__est).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_secure(__secure).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_preferSecure(__preferSecure).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_router(__router).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_locator(__locator).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_collocationOptimized(__co).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_twoway().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_oneway().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_batchOneway().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_datagram().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_batchDatagram().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_compress(__compress).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_timeout(__timeout).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<Motors*>(_Base::ice_connectionId(__id).get());
    #else
...
public:
    ...
    virtual ::Ice::Float getV(const ::Ice::Context*) = 0;

    virtual ::Ice::Int setV(::Ice::Float, const ::Ice::Context*) = 0;

    virtual ::Ice::Float getW(const ::Ice::Context*) = 0;

    virtual ::Ice::Int setW(::Ice::Float, const ::Ice::Context*) = 0;

    virtual ::Ice::Float getL(const ::Ice::Context*) = 0;

    virtual ::Ice::Int setL(::Ice::Float, const ::Ice::Context*) = 0;
};
...
public:
    ...
    virtual ::Ice::Float getV(const ::Ice::Context*);

    virtual ::Ice::Int setV(::Ice::Float, const ::Ice::Context*);

    virtual ::Ice::Float getW(const ::Ice::Context*);

    virtual ::Ice::Int setW(::Ice::Float, const ::Ice::Context*);

    virtual ::Ice::Float getL(const ::Ice::Context*);

    virtual ::Ice::Int setL(::Ice::Float, const ::Ice::Context*);
};
