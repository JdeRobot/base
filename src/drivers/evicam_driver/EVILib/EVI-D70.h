...
#ifndef __EVI_D70_CLASS__
#define __EVI_D70_CLASS__

//-------------------------------------------------------------------------

#define cam_type "EVI-D70"
...
#define EVILIB_maxZoomC    31424 // 0 -> 16384 (4000) = optical zoom | 16385 -> 31424 (7AC0) = digital zoom in Combined mode
...
class EVI_D70 : virtual public EVI_D70g
{
 public:
// Constructor
  EVI_D70();
