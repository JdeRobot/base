 ...
 */
int EVI_D70P::Zoom(int type, int speed, float zoom, int waitC)
{
  if(power == EVILIB_ON)
    {
 ...
 * Return 1 on success, 0 on error
 */
int EVI_D70P::ZoomPosInq(float &zoom)
{
  zoom = -1.0;
  if(power == EVILIB_ON)
    {
 ...
 * Return 1 on success, 0 on error
 */
int EVI_D70P::DZoom(int type, int speed, float zoom, int waitC)
{
  if(power == EVILIB_ON)
    {
      pthread_mutex_lock(&BufferDispo);
 ...
 * Return 1 on success, 0 on error
 */
int EVI_D70P::ZoomFocus(float zoom, int focus, int waitC)
{
  if(power == EVILIB_ON)
    {
      pthread_mutex_lock(&BufferDispo);
 ...
 * Return 1 on success, 0 on error
 */
int EVI_D70P::DZoomPosInq(float &zoom)
{
  zoom = -1.0;
  if(power == EVILIB_ON)
    {
 ...
 * Return 1 on success, 0 on error
 */
int EVI_D70P::Shutter(int type, int speed, int waitC)
{
  if(power == EVILIB_ON)
    {
      pthread_mutex_lock(&BufferDispo);
 ...
 * Return 1 on success, 0 on error
 */
int EVI_D70P::ShutterPosInq(int &shutter)
{
  shutter = -1;
  if(power == EVILIB_ON)
    {
