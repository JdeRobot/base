	...
	IF( ZeroCIce_${exec}_BIN )
		...
		IF(ZeroCIce_${exec}_FOUND)
			IF (NOT ZeroCIceUtil_FIND_QUIETLY)
				MESSAGE(STATUS "Found ZeroC Ice ${exec} at ${ZeroCIce_${exec}_BIN}")
			ENDIF (NOT ZeroCIceUtil_FIND_QUIETLY)
		ELSE(ZeroCIce_${exec}_FOUND)
			IF(ZeroCIce_${exec}_FIND_REQUIRED)
				MESSAGE(FATAL_ERROR "Could NOT find ZeroC Ice ${ZeroCIce_${exec}_BIN}")
			ELSE(ZeroCIce_${exec}_FIND_REQUIRED)
				MESSAGE(STATUS "Could NOT find ZeroC Ice ${ZeroCIce_${exec}_BIN}")
			ENDIF(ZeroCIce_${exec}_FIND_REQUIRED)
		ENDIF(ZeroCIce_${exec}_FOUND)
	ENDIF( ZeroCIce_${exec}_BIN )
